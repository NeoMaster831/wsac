...
public class HandlerCollectionGenerator : IIncrementalGenerator
{
    ...
    private static (ClassDeclarationSyntax, bool Found) GetClassDeclarationForSourceGen(
        GeneratorSyntaxContext ctx)
    {
        ...
        foreach (var attr in attrList.Attributes)
        {
            ...
            if (attributeName == "WsACService.InterProcess.FrameHandlerAttribute")
                return (clsDecl, true);
        }
        ...
        ImmutableArray<ClassDeclarationSyntax>               classDeclarations)
    {
        var builder = new StringBuilder()
            ...
            .AppendLine()
            .AppendLine("namespace WsACService;")
            .AppendLine()
            .AppendLine("public partial class FrameHandler {")
            .AppendLine("    public static global::WsACService.InterProcess.Abstractions.IFrameHandler[] All { get; } = {");
